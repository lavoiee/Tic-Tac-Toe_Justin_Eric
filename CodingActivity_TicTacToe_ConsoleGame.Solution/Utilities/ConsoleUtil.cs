...
namespace CodingActivity_TicTacToe_ConsoleGame
{
    ...
    public static class ConsoleUtil
    {
        ...
        private static string _headerText = "Knots & Crosses 2.0";

        private static ConsoleColor _headerBackgroundColor = ConsoleColor.DarkGray;
        private static ConsoleColor _headerForegroundColor = ConsoleColor.Yellow;
        ...
        private static string _windowTitle = " Tic Tac Bro Inc. ";
